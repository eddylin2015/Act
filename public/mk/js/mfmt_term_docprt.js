...
function docprt(term, crsname,eog, t1, e1, total1, t2, e2, total2, t3, e3, total3) {
    document.write("<tr>");
    ...
    if (term == 1) {
        ...
        document.write("<td class=mke>");  if (eog > 0) document.write(total1.toFixed(2));
        StarFlag(total1);
    } else if (term == 2) {
        document.write("<td class=mk1>");   document.write(t2);
        document.write("<td class=mk1>");   document.write(e2);
        document.write("<td class=mke>");   if (eog > 0) document.write(total2.toFixed(2));
        StarFlag(total2);
    } else if (term == 3) {
        document.write("<td class=mk1>");   document.write(t3);
        document.write("<td class=mk1>");   document.write(e3);
        document.write("<td class=mke>");   if (eog > 0) document.write(total3.toFixed(2));
        StarFlag(total3);
    }
}